...
Після успішного виконання даної команди у поточній відкритій директорї повинна з'явитись нова під директорія `barch-encoder`. Отож відкрий її за допомогою команди `cd barch-encoder`.
